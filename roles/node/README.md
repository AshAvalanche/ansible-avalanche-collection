...
| `avalanchego_bootstrap_db`        | Local path to a snapshot of Avalanche db                                                                                                                                            | `""`                                                           |
...
| `avalanchego_chains_configs`      | The configuration of each chain. See [Chain Configs](https://docs.avax.network/nodes/maintain/chain-config-flags) addresses                                                         | `{ C: { state-sync-enabled: true }}`                           |
